  ...
  return (
    <div className={styles.homeContainer}>
              ...
              <div className={styles.rightMain}>
                ...
                <div className={styles.parag}>
                  <div className={styles.innerParag}>
                    {' '}
                    Offerwalls are a great monetization tool primarily because
                    they help gaming publishers and developers reach a wider
          ...
          <div className={styles.innerBelowFirst1}>
            <div className={styles.innerBelowBox1}>
              ...
              <div className={styles.study}>
                A study by App Annie found that adding Offerwalls to your
                existing monetization strategy increases retention by 50% - Why?
                The answer is…more choice for the user. 
              </div>
            </div>
          </div>
          ...
          <div className={styles.innerBelowFirst2}>
            <div className={styles.innerBelowBox2}>
              ...
              <div className={styles.explore}>
                ...
                updates on maximizing your earnings through offerwall
                monetisation.
              </div>
          ...
          <div className={styles.anOfferwall}>
            <div className={styles.innerAnOfferwall}>
              <div className={styles.anOfferwallParag}>
                An Offerwall is a type of in-app advertising unit that allows
                users to earn rewards by completing certain actions like
                downloading apps, signing up for newsletters, or conducting
                surveys. The user earns in-game currency and the gaming
      ...
      <div className={styles.thirdHomeContainer}>
        <div
          style={{
            backgroundImage: 'url(/images/Th1.png)',
            height: '982px',
            maxWidth: '1512px'
          }}
        >
          <div className={styles.thirdHomeContainerBox}>
            <div className={styles.mobileProblem}>
              ...
              <div className={styles.mobileProblem2}>
                {' '}
            ...
            <div className={styles.gameDeveloper}>
              <div className={styles.gameDeveloper1}>
              ...
              <div className={styles.fourth13}>
                <div className={styles.fourth13One}>
                  <div className={styles.innerOne}>
                    ...
                    <div className={styles.fourth13Integration}>
                      Offerwall integration is seamless with existing ad
                      monetization or paywall structures
                    </div>
                  </div>
                </div>
                <div className={styles.fourth13Two}>
                  <div className={styles.innerOne}>
                    ...
                    />
                    <div className={styles.fourth13Integration}>
                      At the point where users decline to pay for premium
                      content in your online shop you can redirect them to an
                      offerwall giving them a different way to make the same
                      payment{' '}
                    </div>
                  </div>
                </div>
                ...
                <div className={styles.fourth24One}>
                  <div className={styles.innerOne}>
                    ...
                    <div className={styles.fourth13Integration}>
                      ...
                      customer lifetime value and monthly recurring revenue{' '}
                    </div>
                  </div>
                </div>
                <div className={styles.fourth24Two}>
                  <div className={styles.innerTwoSecond}>
                    ...
                    <div className={styles.fourth13Integration}>
                      ...
                      customise the service for a seamless integration within
                      your app to maximize the profit from your offerwall
                      monetization{' '}
                    </div>
                  </div>
                </div>
      ...
      <div className={styles.fifthHomeContainer}>
        <div
          style={{
            backgroundImage: 'url(/images/rect01.png)',
            width: '100vw',
            maxWidth: '1512px',
            height: '968px',
            display: 'flex',
          ...
          <div className={styles.innerFifthHomeContainer1}>
            <div className={styles.innerFifthMainBox1}>
              ...
              <div className={styles.highest}>
                {' '}
                highest among non- <br />
                paying users.
              </div>
            </div>

            <div className={styles.innerFifthMainBox2}>
              The 2019 <u>Swrve Monetization Report</u> found that only 1.6% of
              all players make an in-app purchase and 72% of these only make
              one.
              <br />
              So what is a developer to do? Well, generally the answer is to
              slam your users with ads. But that is what has led the industry to
              have churn rates that average around <u>80% after 3 days.</u>{' '}
              That’s not great.
            </div>
      ...
      <div className={styles.seventhHomeContainer}>
        <div
          style={{
            backgroundImage: 'url(/images/rect_1203.png)',
            width: '100vw',
            maxWidth: '1512px',
            height: '2760px',
            display: 'flex',
          ...
          <div className={styles.seventhHomeBox1}>
            <div className={styles.implementingSoln}>
              ...
              <div className={styles.an}>
                an offerwall solution provides you{' '}
              </div>
            </div>
            ...
            <div className={styles.innerSeventhHome}>
              <div className={styles.rightSevenBox3}>
                ...
                <div className={styles.schedule}>
                  Learn more or schedule a call for advice on how you can
                  maximize the impact of offerwall monetization on your own
                  mobile games. 
                </div>
                <div>
