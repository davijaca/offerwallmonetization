...
const Home = () => {
    ...
    return (
        <div className={styles.homeContainer}>
            ...
            <div className={styles.desktopResponsive}>
            ...
            <div className={styles.mobileResponsive}>
                ...
                <div className={styles.mobileSection1}>
                    <div className={styles.heroMobileSection} style={{ backgroundImage: "url(/images/hero.png)"}}>
                        <div className={styles.heroMobileOfferwall}>
                            A Valuable Tool
                            <div  className={styles.mobileForMonetizing}>
                                <div> for </div>&nbsp;
                                <div className={styles.mobileMonetizing}> Monetizing </div>
                            </div>
                            Mobile Games
                        </div>

                        <div className={styles.mobileiphoneImg}>
                            <img src="/images/iPhone_14 _Pro.png" alt="image"/>
                        </div>
                        <div className={styles.mobileGreatMonetization}>
                            Offerwalls are a great monetization tool primarily because they help gaming publishers and developers reach a wider audience which in turn…
                        </div>
                        <div className={styles.retentionGenerates}>
                            <div className={styles.incRetention}>Increases retention</div>
                            <div className={styles.generatesAdd}>Generates additional revenue</div>
                        </div>
                        <div>
                            <img src="/images/downClick.png" alt="image" />
                        </div>
                    </div>
                </div>

                <div className={styles.mobileSection2}>
                    <div className={styles.mobilePerc}>
                        <div className={styles.fiftyPerc}>50 %</div>
                        <div className={styles.retent}>retention increase</div>
                        <div className={styles.offerwallStudy}>A study by App Annie found that adding Offerwalls to your existing monetization strategy increases retention by 50% - Why? The answer is…more choice for the user. </div>
                    </div>
                    <div className={styles.mobileBlog}>
                        <div className={styles.fiftyPerc}>Blog</div>
                        <div className={styles.offerwallStudy}>Explore our blog for expert tips, success stories, and industry updates on maximizing your earnings through offerwall monetisation.</div>
                        <button className={styles.mobileMore}>Read More</button>
                    </div>
                </div>

                <div className={styles.mobileSection3}>
                ...
                <div className={styles.mobileSection4}>
                ...
                <div className={styles.mobileSection5}>
                   <div></div>
                   <div></div>
                   <div></div>
                </div>

                <div className={styles.mobileSection6}></div>

                <div className={styles.mobileSection7}></div>

                <div className={styles.mobileSection8}></div>
